CREATE TABLE IF NOT EXISTS institution(
  ...
  name TEXT NOT NULL,
  category INT NOT NULL REFERENCES institution_category(id),
  created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP WITH TIME ZONE
);

INSERT INTO institution (category, name)
VALUES
  ...
  (15, 'Kota Administrasi Jakarta Timur'),
  (15, 'Kota Administrasi Jakarta Utara'),
  (15, 'Kabupaten Administrasi Kepulauan Seribu'),
  (16, 'Kabupaten Bantul'),
  (16, 'Kabupaten Gunungkidul'),
  (16, 'Kabupaten Kulon Progo'),
  (16, 'Kabupaten Sleman'),
  (16, 'Kota Yogyakarta'),
  (17, 'Kabupaten Badung'),
  (17, 'Kabupaten Bangli'),
  ...
  (20, 'Kota Pontianak'),
  (20, 'Kota Singkawang'),
  (21, 'Kabupaten Balangan'),
  (21, 'Kabupaten Banjar'),
  (21, 'Kabupaten Barito Kuala'),
  (21, 'Kabupaten Hulu Sungai Selatan'),
  (21, 'Kabupaten Hulu Sungai Tengah'),
  (21, 'Kabupaten Hulu Sungai Utara'),
  (21, 'Kabupaten Kotabaru'),
  (21, 'Kabupaten Tabalong'),
  (21, 'Kabupaten Tanah Bumbu'),
  (21, 'Kabupaten Tanah Laut'),
  (21, 'Kabupaten Tapin'),
  (21, 'Kota Banjarbaru'),
  (21, 'Kota Banjarmasin'),
  (22, 'Kabupaten Barito Selatan'),
  (22, 'Kabupaten Barito Timur'),
  (22, 'Kabupaten Barito Utara'),
  (22, 'Kabupaten Gunung Mas'),
  (22, 'Kabupaten Kapuas'),
  (22, 'Kabupaten Katingan'),
  (22, 'Kabupaten Kotawaringin Barat'),
  (22, 'Kabupaten Kotawaringin Timur'),
  (22, 'Kabupaten Lamandau'),
  (22, 'Kabupaten Murung Raya'),
  (22, 'Kabupaten Pulang Pisau'),
  (22, 'Kabupaten Sukamara'),
  (22, 'Kabupaten Seruyan'),
  ...
  (24, 'Kota Tarakan'),
  (25, 'Kabupaten Boalemo'),
  (25, 'Kabupaten Bone Bolango'),
  (25, 'Kabupaten Gorontalo'),
  (25, 'Kabupaten Gorontalo Utara'),
  (25, 'Kabupaten Pohuwato'),
  (25, 'Kota Gorontalo'),
  (26, 'Kabupaten Bantaeng'),
  (26, 'Kabupaten Barru'),
  (26, 'Kabupaten Bone'),
  (26, 'Kabupaten Bulukumba'),
  (26, 'Kabupaten Enrekang'),
  (26, 'Kabupaten Gowa'),
  (26, 'Kabupaten Jeneponto'),
  (26, 'Kabupaten Kepulauan Selayar'),
  (26, 'Kabupaten Luwu'),
  (26, 'Kabupaten Luwu Timur'),
  (26, 'Kabupaten Luwu Utara'),
  (26, 'Kabupaten Maros'),
  (26, 'Kabupaten Pangkajene dan Kepulauan'),
  (26, 'Kabupaten Pinrang'),
  (26, 'Kabupaten Sidenreng Rappang'),
  (26, 'Kabupaten Sinjai'),
  (26, 'Kabupaten Soppeng'),
  (26, 'Kabupaten Takalar'),
  (26, 'Kabupaten Tana Toraja'),
  (26, 'Kabupaten Toraja Utara'),
  (26, 'Kabupaten Wajo'),
  (26, 'Kota Makassar'),
  (26, 'Kota Palopo'),
  (26, 'Kota Parepare'),
  (27, 'Kabupaten Bombana'),
  (27, 'Kabupaten Buton'),
  (27, 'Kabupaten Buton Selatan'),
  (27, 'Kabupaten Buton Tengah'),
  (27, 'Kabupaten Buton Utara'),
  (27, 'Kabupaten Kolaka'),
  (27, 'Kabupaten Kolaka Timur'),
  (27, 'Kabupaten Kolaka Utara'),
  (27, 'Kabupaten Konawe'),
  (27, 'Kabupaten Konawe Kepulauan'),
  (27, 'Kabupaten Konawe Selatan'),
  (27, 'Kabupaten Konawe Utara'),
  (27, 'Kabupaten Muna'),
  (27, 'Kabupaten Muna Barat'),
  (27, 'Kabupaten Wakatobi'),
  (27, 'Kota Bau-Bau'),
  (27, 'Kota Kendari'),
  ...
  (29, 'Kabupaten Bolaang Mongondow Selatan'),
  (29, 'Kabupaten Bolaang Mongondow Timur'),
  (29, 'Kabupaten Bolaang Mongondow Utara'),
  (29, 'Kabupaten Kepulauan Sangihe'),
  (29, 'Kabupaten Kepulauan Siau Tagulandang Biaro'),
  (29, 'Kabupaten Kepulauan Talaud'),
  (29, 'Kabupaten Minahasa'),
  (29, 'Kabupaten Minahasa Selatan'),
  (29, 'Kabupaten Minahasa Tenggara'),
  (29, 'Kabupaten Minahasa Utara'),
  (29, 'Kota Bitung'),
  (29, 'Kota Kotamobagu'),
  (29, 'Kota Manado'),
  (29, 'Kota Tomohon'),
  ...
  (33, 'Kabupaten Deiyai'),
  (33, 'Kabupaten Dogiyai'),
  (33, 'Kabupaten Intan Jaya'),
  (33, 'Kabupaten Jayapura'),
  (33, 'Kabupaten Jayawijaya'),
  (33, 'Kabupaten Keerom'),
  (33, 'Kabupaten Kepulauan Yapen'),
  (33, 'Kabupaten Lanny Jaya'),
  (33, 'Kabupaten Mamberamo Raya'),
  (33, 'Kabupaten Mamberamo Tengah'),
  (33, 'Kabupaten Mappi'),
  (33, 'Kabupaten Merauke'),
  (33, 'Kabupaten Mimika'),
  (33, 'Kabupaten Nabire'),
  (33, 'Kabupaten Nduga'),
  (33, 'Kabupaten Paniai'),
  ...
  (33, 'Kabupaten Puncak'),
  (33, 'Kabupaten Puncak Jaya'),
  (33, 'Kabupaten Sarmi'),
  (33, 'Kabupaten Supiori'),
  (33, 'Kabupaten Tolikara'),
  (33, 'Kabupaten Waropen'),
  (33, 'Kabupaten Yahukimo'),
  (33, 'Kabupaten Yalimo'),
  (33, 'Kota Jayapura'),
  (34, 'Kabupaten Fakfak'),
  ...
  (35, 'PT Telkom Indonesia (Persero) Tbk'),
  (35, 'PT Danareksa (Persero)'),
  (35, 'Perum Produksi Film Negara'),
  (35, 'Perum Percetakan Uang Republik Indonesia'),
  (36, 'PT Pertamina (Persero)'),
  (36, 'PT Perusahaan Listrik Negara (Persero)'),
  (37, 'PT Indonesia Asahan Aluminium (Persero)'),
  (38, 'PT Perkebunan Nusantara III (Persero)'),
  (38, 'Perum Kehutanan Negara'),
  (39, 'PT Pupuk Indonesia (Persero)'),
  (39, 'PT Rajawali Nusantara Indonesia (Persero)'),
  (39, 'Perum Badan Usaha Logistik'),
  (40, 'PT Bio Farma (Persero)'),
  (41, 'PT Biro Klasifikasi Indonesia (Persero)'),
  (41, 'PT Krakatau Steel (Persero) Tbk'),
  (41, 'PT Len Industri (Persero)'),
  (41, 'PT Industri Kereta Api (Persero)'),
  (42, 'PT Bank Mandiri (Persero) Tbk'),
  (42, 'PT Bank Negara Indonesia (Persero) Tbk'),
  (42, 'PT Bank Rakyat Indonesia (Persero) Tbk'),
  (42, 'PT Bank Tabungan Negara (Persero) Tbk'),
  (43, 'PT Asuransi Jiwasraya (Persero)'),
  (43, 'PT Asuransi Sosial Angkatan Bersenjata Republik Indonesia (Persero)'),
  (43, 'PT Bahana Pembinaan Usaha Indonesia (Persero)'),
  (43, 'PT Reasuransi Indonesia Utama (Persero)'),
  (43, 'PT Taspen (Persero)'),
  (44, 'PT Adhi Karya (Persero) Tbk'),
  (44, 'PT Brantas Abipraya (Persero)'),
  (44, 'PT Hutama Karya (Persero)'),
  (44, 'PT Jasa Marga (Persero) Tbk'),
  (44, 'PT Pembangunan Perumahan (Persero) Tbk'),
  (44, 'PT Semen Indonesia (Persero) Tbk'),
  (44, 'PT Waskita Karya (Persero) Tbk'),
  (44, 'PT Wijaya Karya (Persero) Tbk'),
  (44, 'Perum Pembangunan Perumahan Nasional'),
  (45, 'PT ASDP Indonesia Ferry (Persero)'),
  (45, 'PT Kereta Api Indonesia (Persero)'),
  (45, 'PT Pelabuhan Indonesia (Persero)'),
  (45, 'PT Pelayaran Nasional Indonesia (Persero)'),
  (45, 'PT Pos Indonesia (Persero)'),
  (45, 'Perum DAMRI'),
  (45, 'Perum Pengangkutan Penumpang Djakarta'),
  (46, 'PT Aviasi Pariwisata Indonesia (Persero)'),
  (46, 'PT Garuda Indonesia (Persero) Tbk'),
  (46, 'Perum Lembaga Penyelenggara Pelayanan Navigasi Penerbangan Indonesia'),
  (47, 'PT Virama Karya (Persero)'),
  (47, 'PT Yodya Karya (Persero)'),
  (47, 'PT Bina Karya (Persero)'),
  (47, 'PT Indra Karya (Persero)'),
  (47, 'Perum Jasa Tirta I'),
  (47, 'Perum Jasa Tirta II'),
  (47, 'PT Amarta Karya (Persero)'),
  (47, 'PT Indah Karya (Persero)'),
  (47, 'PT Barata Indonesia (Persero)'),
  (47, 'PT Boma Bisma Indra (Persero)'),
  (47, 'PT Djakarta Lloyd (Persero)'),
  (47, 'PT Dok dan Perkapalan Kodja Bahari (Persero)'),
  (47, 'PT Dok dan Perkapalan Surabaya (Persero)'),
  (47, 'PT Industri Telekomunikasi Indonesia (Persero)'),
  (47, 'PT Industri Kapal Indonesia (Persero)'),
  (47, 'PT Pengusahaan Daerah Industri Pulau Batam (Persero)'),
  (47, 'PT Primissima (Persero)'),
  (47, 'PT Semen Kupang (Persero)'),
  (47, 'PT Varuna Tirta Prakasya (Persero)'),
  (47, 'Perum Lembaga Kantor Berita Nasional Antara'),
  (47, 'Perum Percetakan Negara Republik Indonesia');