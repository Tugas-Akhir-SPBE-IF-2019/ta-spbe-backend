...
class TestApp(unittest.TestCase):
    def test_process_similarity_single_document(self):
        mock_message_data = {
            ...
            'support_document_list': [
                {
                    'name': '494b7a86a26b464a94e9d8c6d6f56ffd.pdf', 
                    'original_name': 'Draft Perbup SPBE 2021 Revisi.pdf', 
                    'type': 'NEW_DOCUMENT'
                }, 
                {
                    'name': '214106cefca94225af0d3c616e75586c.pdf', 
                    'original_name': 'BatuBara.pdf', 
                    'type': 'OLD_DOCUMENT'
                }, 
                {
                    'name': 'fb24e78b895446f78300a3dab27c255f.pdf', 
                    'original_name': 'PhakPhakBarat.pdf', 
                    'type': 'OLD_DOCUMENT'
                }, 
                {
                    'name': '4e5ecedf2efc45a09e333d5715e787d2.pdf', 
