...
func TestUploadSPBEDocument_Success(t *testing.T) {
	...
	r.Post("/assessments/documents/upload", UploadSPBEDocument(mockAssessmentRepo, mockUserRepo, mockMessageQueue, mockMailer, mockFileSystemIO, mockJsonEC, mockConfig.API, mockConfig.SMTPClient))
	r.ServeHTTP(rr, req)
