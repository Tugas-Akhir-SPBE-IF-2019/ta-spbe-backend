...
func (c *healthcheckServiceClient) GetHealthcheck(ctx context.Context, in *HealthcheckRequest, opts ...grpc.CallOption) (*HealthcheckResponse, error) {
	out := new(HealthcheckResponse)
	err := c.cc.Invoke(ctx, "/bfi.bravoservice.healthcheck.HealthcheckService/GetHealthcheck", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHealthcheckServiceServer) GetHealthcheck(context.Context, *HealthcheckRequest) (*HealthcheckResponse, error) {
...
func _HealthcheckService_GetHealthcheck_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bfi.bravoservice.healthcheck.HealthcheckService/GetHealthcheck",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HealthcheckServiceServer).GetHealthcheck(ctx, req.(*HealthcheckRequest))
	}
...
var HealthcheckService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bfi.bravoservice.healthcheck.HealthcheckService",
	...
	Metadata: "spbe/service/healthcheck/healthcheck.proto",
}
